...
from .Res2Net_v1b_TTA import res2net50_v1b_26w_4s

norm = nn.BatchNorm2d


class BasicConv2d(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, stride=1, padding=0, dilation=1, norm=norm):
...
class PraNet(nn.Module):
    ...
    def __init__(self, channel=32):
        ...
        self.ra2_conv1 = BasicConv2d(512, 64, kernel_size=1, norm=norm)
        self.ra2_conv2 = BasicConv2d(64, 64, kernel_size=3, padding=1, norm=norm)
        self.ra2_conv3 = BasicConv2d(64, 64, kernel_size=3, padding=1, norm=norm)
        self.ra2_conv4 = BasicConv2d(64, 1, kernel_size=3, padding=1, norm=norm)
